  ...
  var SetObject = function(key, value) {
    ...
    try {
      ...
      if (
        ...
        console.error(
          "Quota exceeded! Clear localStorage to solve problem. WARNING: Clearing localStorage will delete all user data."
        );
      } else {
        console.error(
          'Unknown error while trying to set an item "' + key + '" with value: '
        );
        console.log(value);
      }
    }
