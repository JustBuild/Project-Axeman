...
function ResourceIndicator() {
  function AppendResourceChild(child, index) {
    ...
    var actualProduction =
      ActiveProfile.Villages[ActiveVillageIndex].Resources.Production[index];
    ...
    if (actualProduction == 0) {
      ...
      if (actualProduction > 0) {
        var max =
          ActiveProfile.Villages[ActiveVillageIndex].Resources.Storage[index];
    ...
    if (ActivePageTravianVersion === "4.4") {
      $(".ResourceIndicatorFillTime").css({
        background:
          "-webkit-linear-gradient(top, rgba(237, 237, 237, 0) 0%,rgba(224, 231, 241, 0.85) 20%) !important",
  ...
  this.Register = function() {
    ...
    if (
      ...
      $("#res").css({
        background:
          "-webkit-linear-gradient(top, rgba(237, 237, 237, 0) 0%,rgba(224, 231, 241, 0.98) 50%) !important",
  ...
  function RefreshFunction(cneg, czero, calmost, cclose, cother) {
    $(".ResourceIndicatorFillTime").each(function() {
      ...
      if ($(this).hasClass("negative")) {
        ...
        if (secondsLeft === 0) $(this).css("color", czero || "#C00");
        else if (secondsLeft < 2700) $(this).css("color", calmost || "#B20C08");
        else if (secondsLeft < 10800) $(this).css("color", cclose || "#A6781C");
...
var ResourceIndicatorMetadata = {
  ...
  Version: "0.2.4.0",
  Description:
    "Shows how long is needed for warehouse and granary to fill up to its maximum capacity and alerts accordingly.",
