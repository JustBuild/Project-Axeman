...
function AutoAdventure() {
  ...
  (this.Register = function() {
    ...
    (this.initialize = function() {
      if (
        !ActiveProfile.Hero.HasAdventure ||
        !ActiveProfile.Hero.CanAdventure
      ) {
        return;
      }
      ...
      if (
        !MatchQuery({ t: 3 }) &&
        !MatchPages([
          Enums.TravianPages.HeroStartAdventure,
      ...
      if (
        MatchQuery({ t: 3 }) &&
        MatchPages([Enums.TravianPages.HeroAdventures])
      ) {
  ...
  this.filterForNormalAdventures = function(adventures) {
    return adventures
      .find('.difficulty img[alt="normal"]')
      .parent()
      .parent();
  };
  ...
  this.filterForHardAdventures = function(adventures) {
    return adventures
      .find('td.difficulty img[alt="hard"]')
      .parent()
      .parent();
  };
}
